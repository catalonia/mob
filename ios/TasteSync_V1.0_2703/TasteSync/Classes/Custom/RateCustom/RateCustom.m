...
- (void) setRateMedium:(double)rate
{
    ...
    {
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_1];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_HALF] forButton:btnPos_2];
    ...
    else if ((rate >=2.3)&&(rate <2.9))
    {
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_1];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_2];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_HALF] forButton:btnPos_3];
    ...
    else if ((rate >=2.9)&&(rate <3.4))
    {
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_1];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_2];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_3];
    ...
    else if ((rate >=3.4)&&(rate <3.9))
    {
        ...
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_2];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_3];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_HALF] forButton:btnPos_4];
    ...
    else if ((rate >=3.9)&&(rate <4.3))
    {
        ...
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_2];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_3];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_4];
    }
    ...
    else if(rate != 0)
    {
        ...
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_3];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_4];
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_ON] forButton:btnPos_5];
    }
...
-(void)setDefault
{
    [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_OFF] forButton:btnPos_1];
    [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_OFF] forButton:btnPos_2];
    [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_OFF] forButton:btnPos_3];
    [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_OFF] forButton:btnPos_4];
    [CommonHelpers setBackgroundImage:[UIImage imageNamed:IC_OFF] forButton:btnPos_5];
}
