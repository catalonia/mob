...
- (id)init {
    if (self = [super initWithFrame:CGRectZero]) {
        ...
        _imageBackground = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"bgbox_rec.png"]];
        [self addSubview:_imageBackground];
        
        
        UIImage* closeImage = [UIImage imageNamed:@"ic_close.png"];
...
//        [self addSubview:_spinner];
        ...
        // design
        UIImageView *imageBackgroundText = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"Writeareview.png"]];
