...
- (IBAction)actionButton:(id)sender
{
    if (!userObj.isSelected) {
        ...
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:@"ic_check_on.png"] forButton:btn];
    }
    else
    {
        userObj.isSelected = NO;
        [CommonHelpers setBackgroundImage:[UIImage imageNamed:@"ic_check.png"] forButton:btn];
    }
}
- (IBAction)actionAdd:(id)sender
{
...
//    ivAvatar.image = [UIImage imageNamed:@"avatar.png"];
    ivAvatar.image = nil;
