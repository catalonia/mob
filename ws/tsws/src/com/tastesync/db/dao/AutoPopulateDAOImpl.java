    ...
    public List<TSRestaurantObj> populateRestaurantSearchTerms(String key, String cityId) throws TasteSyncException
    {
    	...
    	if(cityId.equals(""))
    	{
            ...
            try {
                ...
                System.out.println("AutoPopulateQueries.RESTAURANT_SELECT_SQL=" +
                    AutoPopulateQueries.RESTAURANT_SELECT_SQL);
    	...
    	else if(key.equals(""))
    	{
            ...
            try {
                ...
                System.out.println("AutoPopulateQueries.RESTAURANT_CITY_SELECT_SQL=" +
    	...
    	else
    	{
            ...
            try {
                ...
                System.out.println("AutoPopulateQueries.RESTAURANT_CITY__KEY_SELECT_SQL=" +
