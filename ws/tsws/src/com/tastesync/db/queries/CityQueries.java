...
public interface CityQueries {
	...
	//city_neighbourhood
	public static String CITY_NEIGHBOURHOOD_KEY_DESC_SELECT_SQL = "SELECT * FROM cities, city_neighbourhood WHERE city_neighbourhood.NEIGHBOURHOOD_DESC LIKE ? AND city_neighbourhood.CITY_ID = cities.city_id";
}
