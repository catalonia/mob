...
public class TSUserProfileObj implements Serializable {
    ...
    private List<TSRestaurantDetailsObj> testaurantDetailsList;
    ...
    @XmlElement
    public List<TSRestaurantDetailsObj> getTestaurantDetailsList() {
        return testaurantDetailsList;
    }
    ...
    public void setTestaurantDetailsList(
        List<TSRestaurantDetailsObj> testaurantDetailsList) {
        this.testaurantDetailsList = testaurantDetailsList;
    }
}
